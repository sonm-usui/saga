...
import { actionLeavePostSurvey, actionPostSurvey } from '../../../store/Common/actions';
...
const SurveyModal: React.FC<SurveyModalProps> = ({ className = '', onClose }) => {
  ...
  return (
    <div className="survey-modal-wrapper">
      <Modal
        open
        onCancel={onClose}
        className={`survey-modal ${className}`}
        footer={null}
        maskClosable={false}
