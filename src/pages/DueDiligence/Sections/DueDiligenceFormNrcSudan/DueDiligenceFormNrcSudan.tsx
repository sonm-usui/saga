...
import {
  DueDiligenceFormNrcSudanSchema,
...
export const DueDiligenceFormNrcSudan: React.FC<{ marketplace: string }> = ({ marketplace }) => {
                    ...
                    <div className="input-half">
                      <div className="item-input">
                        ...
                        <Field
                          ...
                          className="input-field"
                        />
                        <ErrorMessage name="bank_name" className="error-message" component="div" />
                      </div>
                      <div className="item-input">
