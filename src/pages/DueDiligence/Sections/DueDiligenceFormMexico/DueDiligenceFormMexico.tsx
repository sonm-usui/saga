...
export const DueDiligenceFormMexico: React.FC<{ marketplace: string }> = ({ marketplace }) => {
  ...
  const initFormValue = {
    ...
    has_organisation_audited_financials: false,
                    ...
                    {values.organization_registered ? (
                      <>
                        ...
                        <div className="input-half">
                          ...
                          <div className="item-input">
                            <div className="title-field">Registration Number, if applicable:</div>
                            <Field
