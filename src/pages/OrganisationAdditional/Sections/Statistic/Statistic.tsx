  ...
  return (
    <div className="statistic">
      ...
      <div className="statistic-list">
        ...
        {/* {map(STATISTIC_LIST, (item) => (
          <div className="statistic-list-item" key={item.id}>
            <div className={`statistic-list-item-value ${item.id === 4 ? 'active' : ''}`}>
              {item.value}
              {item.id === 4 && <span className="percentage">%</span>}
            </div>
            <div className={`statistic-list-item-title ${item.id === 1 ? 'active' : ''}`}>
              {item.title}
            </div>
            {item.id === 1 && (
              <div className="currency">
