...
export const HIGHT_RICK_COUNTRIES = ['Sudan', 'Somalia'];

export const ACTIVE_COUNTRY_NAMES = ['Sudan', 'Somalia', 'Myanmar', 'Hong Kong', 'Mexico'];

export const ACTIVE_COUNTRIES = COUNTRIES.filter((country: any) =>
  ACTIVE_COUNTRY_NAMES.includes(country.name)
);
