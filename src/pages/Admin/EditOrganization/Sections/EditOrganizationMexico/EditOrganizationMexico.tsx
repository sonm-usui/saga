...
import {
  DueDiligenceFormMexicoSchema,
  DueDiligenceFormPublicSchema
} from '../../../../../formik-schemas';
...
export const EditOrganizationMexico: React.FC<{ marketplace: string; organisationDetail: any }> = ({
  marketplace,
  organisationDetail
}) => {
  const {
          ...
          <div className="container">
            ...
            <div className="due-diligence-form">
              <Formik
                ...
                validationSchema={DueDiligenceFormMexicoSchema}
                onSubmit={(payload) => {
                  handleEditOrganization({
                    ...payload,
                    ...
                    <Form className="due-diligence-form-wrapper">
                      ...
                      <div className="form-section">
                        ...
                        {values.organization_registered ? (
                          <>
                            <div className="item-input">
                              <div className="title-field">Proof of Registration:</div>
                              <Upload
