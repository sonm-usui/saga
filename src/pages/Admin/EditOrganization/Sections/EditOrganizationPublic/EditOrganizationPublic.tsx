...
import { DueDiligenceFormPublicSchema } from '../../../../../formik-schemas';
...
import { COUNTRIES, HIGHT_RICK_COUNTRIES } from '../../../../ProposeProject/countries';
...
export const EditOrganizationPublic: React.FC<{ marketplace: string; organisationDetail: any }> = ({
  marketplace,
  organisationDetail
}) => {
  const {
  ...
  const initFormValue = {
    ...
    key_staff: organisationDetail?.key_staff
      ? map(organisationDetail?.key_staff, (staffMember) => {
          return {
            ...
            identification: staffMember?.identification || []
          };
        })
    ...
    has_organisation_audited_financials:
      organisationDetail?.has_organisation_audited_financials || false,
    explain_does_not_have_most_recently_audited_financials:
      organisationDetail?.explain_does_not_have_most_recently_audited_financials || '',
    most_recent_audited_financials: organisationDetail?.most_recent_audited_financials || [],
    removed_most_recent_audited_financials: '',
    most_recent_annual_impact_report: organisationDetail?.most_recent_annual_impact_report || [],
    removed_most_recent_annual_impact_report: ''
  };
          ...
          <div className="container">
            ...
            <div className="due-diligence-form">
              <Formik
                ...
                validationSchema={DueDiligenceFormPublicSchema}
                onSubmit={(payload) => {
                  handleEditOrganization({
                    ...payload,
                  ...
                  return (
                    <Form className="due-diligence-form-wrapper">
                      ...
                      <div className="form-section">
                        ...
                        {!HIGHT_RICK_COUNTRIES.includes(values.registered_country) && (
                          <>
                            <div className="item-input">
                              <div className="title-field">
                                Does your organisation have audited financials?
                              </div>
                              <Radio.Group
                                onChange={() => {
                                  setFieldValue(
                                    `has_organisation_audited_financials`,
                                    !values.has_organisation_audited_financials
                                  );
                                }}
                                value={values.has_organisation_audited_financials}>
                            ...
                            {!values.has_organisation_audited_financials && (
                              <div className="item-input">
                                <div className="title-field">Please explain:</div>
                                <Field
                                  name="explain_does_not_have_most_recently_audited_financials"
                                  type="text"
                                  placeholder="Explain"
                                  className="input-field"
                                />
                        ...
                        {(HIGHT_RICK_COUNTRIES.includes(values.registered_country) ||
                          ...
                          <div className="item-input">
                            <div className="title-field">
                              {`Please upload the organisation's most recent audited financials:`}
                            </div>
                            <Upload
                              className="upload-input"
                              beforeUpload={handleBeforeUpload}
                              ...
                              onChange={(info) => {
                                setFieldValue(
                                  'most_recent_audited_financials',
                                  info.fileList.map((p) => p.originFileObj)
                                );
                              }}>
                              <ButtonAntd icon={<UploadOutlined />}>Click to Upload</ButtonAntd>
                            ...
                            <DocumentUploaded
                              documents={organisationDetail?.most_recent_audited_financials}
                              onSetFieldValue={(value) => {
                                setFieldValue(
                                  'removed_most_recent_audited_financials',
                                  value?.join(',')
                      ...
                      <div className="form-section">
                        ...
                        {HIGHT_RICK_COUNTRIES.includes(values.registered_country) ? (
                          <>
                            <div className="item-input">
                              <div className="title-field">
                                Do you collaborate with armed groups:{' '}
                              </div>
                              <Radio.Group
                                onChange={() => {
                                  setFieldValue(
                          ...
                          <div className="item-input">
                            <div className="title-field">
                              {
                                "Please upload your organisation's most recent annual / impact report here, if you have one:"
                              }
                            </div>
                            <Upload
                              className="upload-input"
                              ...
                              onChange={(info) => {
                                setFieldValue(
                                  'most_recent_annual_impact_report',
                                  info.fileList.map((p) => p.originFileObj)
                                );
                              }}>
                              <ButtonAntd icon={<UploadOutlined />}>Click to Upload</ButtonAntd>
                            ...
                            <DocumentUploaded
                              documents={organisationDetail?.most_recent_annual_impact_report}
                              onSetFieldValue={(value) => {
                                setFieldValue(
                                  'removed_most_recent_annual_impact_report',
                                  value?.join(',')
